...
def main(args):
    ...
    try:
        with h5py.File(input_h5, 'r') as f:
            ...
            for traj_key in trajectory_keys[:2]:
        ...
        print(view0_arrays.shape)
        print(view1_arrays.shape)
        # 设置chunk大小
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input', type=str, default="../demo_0828/PushCube-v1/motionplanning/action.h5",  help='输入原始.h5文件路径')
