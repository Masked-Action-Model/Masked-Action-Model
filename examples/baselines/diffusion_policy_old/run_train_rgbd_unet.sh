...
# Train script for examples/baselines/diffusion_policy/train_rgbd_unet.py
# Override any value by exporting the variable before running this script.

EXP_NAME="${EXP_NAME:-PickCube_rgbd_unet}"
SEED="${SEED:-1}"
...
python examples/baselines/diffusion_policy/train_rgbd_unet.py "${ARGS[@]}"
