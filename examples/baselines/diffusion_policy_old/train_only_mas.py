...
from diffusion_policy.evaluate_only_mas import evaluate_only_mas
...
class Args:
    ...
    """the path of test demo dataset used for online eval mas conditioning (required)"""
...
def load_eval_only_mas_data(
    ...
    return {"mas_flat": mas_flat_list, "mas": mas_list}
...
class SmallDemoDataset_DiffusionPolicy(Dataset):  # Load everything into memory
    def __init__(self, data_path, obs_process_fn, obs_space, device, num_traj):
        ...
        load_keys = ["observations", "actions", "mas", "env_states", "success", "terminated", "truncated"]
