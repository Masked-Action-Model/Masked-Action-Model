...
当前data preprocess流程：
  ...
  - 调用 `examples/baselines/diffusion_policy/data_preprocess/data_preprocess.py`，这个脚本再调用 `data_preprocess/utils/*` 里的函数。

- 具体调用链：
  - `run_train_mas_window.sh`
  - `data_preprocess.py`
  - `data_preprocess/utils/mask_utils.py`
  - `data_preprocess/utils/normalize_utils.py`
...
- 底层 mask / normalize / progress 工具仍然共用 `data_preprocess/utils/*`。
...
#### 2. `examples/baselines/diffusion_policy/data_preprocess/data_preprocess.py`
...
#### 3. `examples/baselines/diffusion_policy/data_preprocess/data_preprocess_mixed.py`
...
#### 6. `examples/baselines/diffusion_policy/data_preprocess/utils/mask_utils.py`
...
#### 7. `examples/baselines/diffusion_policy/data_preprocess/utils/progress_utils.py`
...
#### 3. `data_preprocess/utils/mask_utils.py`
