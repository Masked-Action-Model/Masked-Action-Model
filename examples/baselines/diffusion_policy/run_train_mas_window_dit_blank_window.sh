...
# Train script for examples/baselines/diffusion_policy/train_mas_window_blank_window.py
...
EXP_NAME="${EXP_NAME:-dit_blank_window}"
SEED="${SEED:-1}"
...
PREPROCESS_RETAIN_RATIO="${PREPROCESS_RETAIN_RATIO:-0.2}"
...
# SHORT_WINDOW will be flattened
...
python examples/baselines/diffusion_policy/train_mas_window_blank_window.py "${ARGS[@]}"
