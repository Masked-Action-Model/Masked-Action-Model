...
- 新增 `examples/baselines/diffusion_policy/data_preprocess.py`
- 新增 `examples/baselines/diffusion_policy/data_preprocess_tools/`
- 已支持：
  - 原始 `h5/json` 读取
...
建议把新文件 `examples/baselines/diffusion_policy/data_preprocess.py` 设计成下面几个阶段。
